...
function openSportsGame(sport, gameId) {
    ...
    const cricketGames = {
        ...
        "cricket-live-1": {
            ...
            info: "Bangladesh vs India - Live Cricket Match"
        },
        ...
        "cricket-live-2": {
            ...
            status: "LIVE",
            league: "T20 International",
            info: "Australia vs Pakistan - Live Cricket Match"
        }
    ...
    if (!game) {
        ...
        console.log("Sports game not found:", sport, gameId);
    ...
    eventPages.forEach(function(id) {
    ...
    // ======================================
    // CREATE FULL GAME PAGE
    // ======================================

    let fullPage = document.getElementById("sports-full-game-page");
    ...
    if (!fullPage) {
        ...
        fullPage.id = "sports-full-game-page";
    ...
    fullPage.innerHTML = `
        ...
        <div class="sports-full-game-content">
...
function backFromSportsGame() {
    ...
    const fullPage =
        document.getElementById("sports-full-game-page");
    ...
    // Reload page to restore the normal Sports page
